...
jQuery(function ($) {
    ...
    $(".action").click(function(e){
        var accordionitem = $(this).attr("data-tab");
        $("#"+accordionitem).slideToggle().parent().siblings().find(".content").slideUp();
    });
    ...
    $('.forum-btn').on('click',function(){
        $('.forum-message').css({'display':'flex'});
        return false;
    });
    //hidden form
    $('.forum-close-btn').on('click',function(){
        $('.forum-message').css({'display':'none'});
        return false;
    });
...
$("#password2").on("keyup", function() { 
    ...
    var value_input1 = $("#password1").val(); 
